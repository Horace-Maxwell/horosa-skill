...
<p>
  ...
  <img src="https://img.shields.io/badge/测试-751_passed-16a34a?style=for-the-badge" alt="751 passed" />
...
| 🧪 工程测试 | **751 / 751 pass**（离线 CI 形状：契约 + 导出 fixture + node JS golden；另 71 项 live 集成测试需本地 runtime，服务未起时自动 skip） |
...
uv run pytest -q                                        # 751 passed（live 集成测试在服务未起时 skip）
