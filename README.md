...
<p>
  ...
  <img src="https://img.shields.io/badge/测试-961_passed-16a34a?style=for-the-badge" alt="961 passed" />
...
| 🧪 工程测试 | **961 / 961 pass**（离线 CI 形状：契约 + 导出 fixture + node JS golden；另 72 项 live 集成测试需本地 runtime，服务未起时自动 skip） |
...
uv run pytest -q                                        # 961 passed（live 集成测试在服务未起时 skip）
