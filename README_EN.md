...
| Engineering tests | `1153 / 1153 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 72 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 1153 passed; live integration tests auto-skip when services are down
