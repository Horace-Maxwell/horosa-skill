...
| Engineering tests | `372 / 372 pass` (ken / Shen Shu live integration + offline golden unit tests + node JS golden) |
...
| Local memory / report | `91 / 91` writes + `91 / 91` JSON artifacts |
...
uv run pytest -q                                        # 372 passed with local backends up; live integration tests auto-skip offline
