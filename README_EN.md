...
| Engineering tests | `654 / 654 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 71 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 654 passed; live integration tests auto-skip when services are down
