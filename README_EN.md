...
| Engineering tests | `1239 / 1239 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 73 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 1239 passed; live integration tests auto-skip when services are down
