...
| Engineering tests | `636 / 636 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 71 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 636 passed; live integration tests auto-skip when services are down
