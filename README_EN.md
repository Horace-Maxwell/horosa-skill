...
| Engineering tests | `588 / 588 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 67 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 588 passed; live integration tests auto-skip when services are down
