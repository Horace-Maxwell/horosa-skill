...
| Engineering tests | `1651 / 1651 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 115 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 1651 passed; live integration tests auto-skip when services are down
