...
| Engineering tests | `1649 / 1649 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 115 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 1649 passed; live integration tests auto-skip when services are down
