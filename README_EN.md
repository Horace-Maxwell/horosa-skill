...
| Engineering tests | `1135 / 1135 pass` (offline CI shape: contract + export fixtures + node JS golden; a further 72 live integration tests need a local runtime and auto-skip when services are down) |
...
uv run pytest -q                                        # 1135 passed; live integration tests auto-skip when services are down
