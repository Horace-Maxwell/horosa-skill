...
import { TAROT_SPREADS } from '../engine/spreads.js';
...
export const BOTA_DECK = {
	...
	caps: { reversals: true, dignities: false, variant: true, significator: true, numOverride: true, embeddedPlayingCard: false, readingMethod: 'tarot', colorScale: true, spreads: ALL_SPREADS },
};
