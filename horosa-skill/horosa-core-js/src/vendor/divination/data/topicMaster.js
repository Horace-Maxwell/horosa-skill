...
export const TOPIC_MASTER = {
	...
	buy_property: { topic_id: 'buy_property', cn: '购屋/租屋', natural_significators: ['moon'], key_houses: [4, 2], preferred_asc_modality: ['fixed'], moon_phase_pref: 'waxing', must_avoid: ['mercury_retro_for_contract'], must_have: ['moon_l4_good_aspect'], topic_lots: ['substance', 'realEstate'], notes: '月落 Cancer 最佳；月-4主吉相；避截夺宫。' },
	buy_land: { topic_id: 'buy_land', cn: '购地', natural_significators: ['saturn', 'moon'], key_houses: [4], preferred_asc_modality: ['fixed'], moon_phase_pref: 'waxing', must_avoid: ['saturn_in_12_property'], must_have: ['moon_saturn_trine'], topic_lots: ['realEstate'], notes: '加 Saturn+Capricorn；月-土 120°有利；配金看实质收入。' },
