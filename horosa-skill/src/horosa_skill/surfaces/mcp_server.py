...
def _selected_toolsets() -> set[str] | None:
    ...
    动机：Claude Code 已用工具搜索解决了 95 工具的上下文膨胀，但 Cursor 一类客户端仍有较紧的工具数
...
Set HOROSA_MCP_COMPACT=1 to expose 11 facade tools instead of 95 (horosa_tool_run reaches every
