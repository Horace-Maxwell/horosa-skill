...
AI_EXPORT_PRESET_SECTIONS = {
    ...
    "mundane": ["世俗入宫", "新月图", "满月图", "日食图", "月食图", "地区盘", "行星周期", "世运问判", "世运卜卦", "世俗宫义", "定局·年主/盘主", "入境骨架", "地理分野", "地区盘推运", "起盘信息", "宫位宫头", "星与虚点", "信息", "相位", "行星", "希腊点", "12分度", "主宰星链", "古典", "埃及历", "寿命格局", "可能性"],
