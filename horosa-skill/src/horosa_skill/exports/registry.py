...
AI_EXPORT_PRESET_SECTIONS = {
    ...
    "sanshiunited": ["起盘信息", "概览", "太乙", "太乙十六宫", "神煞", "大六壬", "六壬大格", "六壬小局", "六壬参考", "六壬概览", "八宫详解", "正北坎宫", "东北艮宫", "正东震宫", "东南巽宫", "正南离宫", "西南坤宫", "正西兑宫", "西北乾宫", "太乙主客定算", "太乙八门与宿曜", "太乙断法", "太乙七大兵法", "太乙博弈", "太乙命法", "太乙命宫行限", "十二盘式", "常用神煞", "年月神煞", "课体结构", "三传旺衰", "空亡真假", "旬空落点", "陷空", "遁干特殊", "年命上神", "毕法（已命中）", "占断向导", "奇门九宫方盘", "奇门旺相休囚死·月令能量", "奇门六害总览", "奇门化解方案", "奇门八门化气大阵", "奇门用神分论", "奇门财富七要", "奇门事业七要", "奇门恋爱姻缘", "奇门孤辰寡宿", "紫微四化"],
