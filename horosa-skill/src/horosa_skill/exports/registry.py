...
AI_EXPORT_PRESET_SECTIONS = {
    ...
    "astrochart_like": ["起盘信息", "宫位宫头", "星与虚点", "信息", "相位", "行星", "月宿", "希腊点", "古典", "古典格局", "埃及历", "可能性", "12分度", "主宰星链", "寿命格局", "占星地图"],
    ...
    # [X3D盘] 与 [X星盘] 是上游同一份盘面文本的两个页签出口（见 service 侧注释），两段都列。
    ...
    **JIEQI_SETTING_PRESETS,
    ...
    "acg": ["起盘信息", "宫位宫头", "星与虚点", "信息", "相位", "行星", "月宿", "希腊点", "12分度", "主宰星链", "古典", "古典格局", "埃及历", "寿命格局", "可能性", "占星地图", "偕升纬度带", "线交点", "落点分析", "事件时刻"],
