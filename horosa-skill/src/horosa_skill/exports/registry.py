...
AI_EXPORT_PRESET_SECTIONS = {
    ...
    **JIEQI_SETTING_PRESETS,
    ...
    "geomancy": ["起卦信息", "判定", "法庭三角", "有效性判断", "解读技法", "盾面得地", "元素与寻源", "成败与福灵点", "转宫派生", "定局落星·甲", "定局落星·乙", "定局落星·真实星历", "行星地占盘", "十二宫·图形入宫", "十六图形", "图形释义", "边界声明"],
...
AI_EXPORT_OPTIONAL_SECTIONS = {
    ...
    "geomancy": ["解读技法", "转宫派生", "定局落星·甲", "定局落星·乙", "图形释义", "边界声明", "法庭三角", "有效性判断", "盾面得地", "元素与寻源", "成败与福灵点", "定局落星·真实星历", "行星地占盘"],
    ...
    "cetian": ["四化", "飞星", "格局", "宫干四化表", "飞化规则", "古法格局规则", "夫妻宮", "子女宮", "交友宮", "父母宮", "衣鉢宮", "徒弟宮", "本師宮", "小師宮", "人刀宮", "僧道宮", "遊行宮", "師號宮", "相品宮"],
}
