...
TOOL_DEFINITIONS: dict[str, ToolDefinition] = {
    ...
    "yizhangjing": ToolDefinition("yizhangjing", "cn", "yizhangjing", None, YizhangjingInput, "Run the local 一掌经 engine (四柱四宫/命宫/人事十二宫/格局/重犯/大限/小限流年十二神/神煞合参).", execution="local"),
    "acg": ToolDefinition("acg", "astro", "acg", None, ACGInput, "Generate the 占星地图 / AstroCartoGraphy line map — per-planet MC/IC/ASC/DESC geographic lines, zenith points, parans, and crossings.", execution="local"),
    "astrodata": ToolDefinition("astrodata", "astro", "astrodata", None, AstrodataInput, "Query the offline celebrity birth-data catalog (FTS search / category / Rodden filter, per-person chart-ready birth data).", execution="local"),
    ...
    "geomancy": ToolDefinition("geomancy", "cn", "geomancy", None, GeomancyInput, "Cast 天文地占 / astronomical geomancy deterministically from the query moment (4 mothers → 16 figures, 12 houses, judge/witnesses, technique reading).", execution="local"),
    "tarot": ToolDefinition("tarot", "cn", "tarot", None, TarotInput, "Draw a 塔罗 / tarot spread deterministically from the query moment (seeded shuffle → cards → verdict/synthesis reading).", execution="local"),
